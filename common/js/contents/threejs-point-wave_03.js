(function (window,document) {
	...
	var container 	= document.getElementById("container"),
		stats,
		camera 		= new THREE.PerspectiveCamera( 27, winWidth / winHeight, 1, 3000 ),
	...
	Member.init = function() {
		...
		zMaterial 	= new THREE.LineBasicMaterial(_xMatParam);
		...
		scene.add( xMesh );
		scene.add( zMesh );
//		scene.fog = new THREE.Fog(param.bgColor,1,1000);
...
//		scene.fog = new THREE.Fog(param.bgColor,2200,2000);
		scene.fog = new THREE.FogExp2(param.bgColor, param.fogLevel*0.00001);
